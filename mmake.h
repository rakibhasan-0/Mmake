 ...
 * 														Furthermore, it checks if the user has given a file and given targets in the terminal.
 * 
 ...
 * @return 	 											It will return the makefile, from the makefile we will create targets with the of its 
 * 														rule and prerequisites. If it cannot return the makefile then it will return NULL.	
 */
